...
<body class="bg-gray-100 h-screen flex items-center justify-center">
    <div class="bg-white p-8 rounded-lg shadow-lg todo-container">
        <h1 class="text-2xl font-bold mb-4">Todo List Item</h1>
        <div class="flex mb-4">
        ...
        <ul>
            <?php foreach ($texts as $index => $task) { ?>
                <li class="flex items-center justify-between mb-2 border-b-2 border-gray-200 py-2 todo-item">
                    ...
                    <form action="<?php echo $_SERVER['PHP_SELF']; ?> " method="post">
                        <button type="submit"
                            class="text-sm text-gray-600 hover:text-red-600 focus:outline-none focus:text-red-600"
                            name="delete" value="<?php echo $index ?>">
                            Delete
                        </button>
                    </form>
                </li>
